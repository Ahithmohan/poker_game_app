...
class AffiliateForgotPassword extends StatefulWidget {
  final LoginResponseModel? playerResponse;

  const AffiliateForgotPassword({super.key, this.playerResponse});

  @override
  State<AffiliateForgotPassword> createState() =>
      _AffiliateForgotPasswordState();
}
